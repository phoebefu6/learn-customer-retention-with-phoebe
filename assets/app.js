...
(function () {
  ...
  /* Journey strip: you-are-here across the sessions (stakeholder track of 4, analyst track of 8) */
  var crumb = document.querySelector(".toolbar .crumb");
  var mastheadWrap = document.querySelector(".masthead .wrap");
  if (crumb && mastheadWrap) {
    var mx = crumb.textContent.match(/Stakeholder session (\d+) of 4/);
    var m = mx || crumb.textContent.match(/Analyst session (\d+) of 8/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["s1-retention-is-the-money-metric.html", "s2-read-the-chart-read-the-business.html",
           "s3-levers-that-move-retention.html", "s4-asking-the-right-questions.html"]
        : ["a1-retention-metrics-precisely.html", "a2-cohort-table-and-heatmap.html",
           "a3-retention-viz-gallery.html", "a4-segmentation-rfm.html",
           "a5-survival-analysis.html", "a6-clv-buy-till-you-die.html",
           "a7-churn-prediction.html", "a8-capstone-retention-report.html"];
